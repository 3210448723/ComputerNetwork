...
3. 逐渐形成了多层次 ISP 结构的互联网。
   ...
   ![image-20230206212527266](https://img-blog.csdnimg.cn/ef51753ef8534ba7bf2deb35424117b6.jpeg)
...
![image-20221209232016007](https://img-blog.csdnimg.cn/e50073edb6ef4da0b51d02be3a769cf9.jpeg)
...
![image-20221210123339871](https://img-blog.csdnimg.cn/cc469029882746f1aef8d9142226aef2.jpeg)
...
![image-20221210123522888](https://img-blog.csdnimg.cn/ba48a993290545f0b6bb978485b9e335.jpeg)
...
![image-20230207211919029](https://img-blog.csdnimg.cn/2beed6f89cdb4ca29a916181c6e1ae85.jpeg)
...
![image-20221210125210317](https://img-blog.csdnimg.cn/1ccbf3b364cb4fafbc8fef9f1b16edb1.jpeg)
...
![image-20230202210707510](https://img-blog.csdnimg.cn/fe93f1fa58274a618fbb27ced131fccf.jpeg)
...
![image-20221211211740508](https://img-blog.csdnimg.cn/36146b7ffcfa49c9958247f2412452d3.jpeg)
...
* ISM频段
  ...
  * ISM是Industrial，Scientific，and Medical (工业、科学与医药）的缩写，即所谓的“工、科、医频段”。各国的ISM标准有可能略有差别。
    ...
    ![image-20230201210714180](https://img-blog.csdnimg.cn/645abcfd48584a86a1935780c962e6aa.jpeg)
...
![image-20221210222104791](https://img-blog.csdnimg.cn/5a9180e33f5841d8829ffdd989e6e1de.jpeg)
...
![image-20221210222255417](https://img-blog.csdnimg.cn/7f7f95c6321e4cb0b87c41c2675b1ea5.jpeg)
...
![image-20230203215115418](https://img-blog.csdnimg.cn/9c23dae1348b46448c98e6f96a07c85a.jpeg)
...
![image-20221210222428947](https://img-blog.csdnimg.cn/92166901b5784b179eb859b352d49690.jpeg)
...
![image-20221210222544070](https://img-blog.csdnimg.cn/cb0ace0c35a1480eadf077800026d5cb.jpeg)
...
![image-20221211215236298](https://img-blog.csdnimg.cn/f5dd03fa856b459f97d3797cb1337c5d.jpeg)

非对称数字用户线 ADSL (Asymmetric Digital Subscriber Line) ：用数字技术对现有的模拟电话用户线进行改造，使它能够承载宽带业务。

### HFC

![image-20221211215346914](https://img-blog.csdnimg.cn/b03633f5ea9b411eacb23e2bb971aabd.jpeg)
...
![image-20230203221431099](https://img-blog.csdnimg.cn/1d24c588d06f48769fbc421607b87b6b.jpeg)

#### 解决方法

![image-20221218163827820](https://img-blog.csdnimg.cn/1bddd414b117422fb80b33a2888844e9.jpeg)
...
![image-20221218172002147](https://img-blog.csdnimg.cn/37732c111bcb41d293503ce7e52baae1.jpeg)
...
1. 面向**字节**的物理链路使用**字节填充** (byte stuffing) 或**字符填充** (character stuffing)
   ...
   ![image-20221218172328346](https://img-blog.csdnimg.cn/5130106e86ac40c8ad1043b17a42353b.jpeg)
...
![image-20221218174847835](https://img-blog.csdnimg.cn/765f39f3eadd41dea9ddf5db2eaa4d4e.jpeg)
...
![image-20221218180316314](https://img-blog.csdnimg.cn/01c4b74b907a4dd98ed1ec506476689f.jpeg)
...
1. 当 PPP 用在**异步**传输时（传输单位为**字节**），就使用一种特殊的**字符填充**法。
   ...
   ![image-20221218181323969](https://img-blog.csdnimg.cn/323ecd7cd2aa4e6d8963feef871a3f4d.jpeg)
...
2. 当 PPP 用在**同步**传输链路时（传输单位为**比特**），协议规定采用硬件来完成**比特填充**。
   ...
   ![image-20221218182101754](https://img-blog.csdnimg.cn/c5dd111102d3471da6d10f125e6138c3.jpeg)

#### 差错检测

![image-20221218182227073](https://img-blog.csdnimg.cn/b5c4bcc427694b83857eddf59e82eef4.jpeg)
...
![image-20221218205714862](https://img-blog.csdnimg.cn/2e8e2ac2cc094607b87666a3ea0143eb.jpeg)
...
![image-20221218205958790](https://img-blog.csdnimg.cn/1b62db87e56c4ff2b7f80bc101244eb7.jpeg)
...
![image-20221228110528980](https://img-blog.csdnimg.cn/11b463f42bd2491ab4db84fd25badd47.jpeg)
...
![image-20221228112833971](https://img-blog.csdnimg.cn/1f8c7f326f21449fac96bbae0902401b.jpeg)
...
集线器（Hub）对接收到的信号进行**再生整形放大**，以**扩大**网络的**传输距离**，同时把所有节点集中在以它为中心的节点上。当集线器一个端口收到数据后，将其从除了输入端口外的所有端口广播出去，即**信息分发**。

###### 冲突域/碰撞域

在任意时刻，在每个碰撞域中只能有一个站在发送数据

![image-20221228120741745](https://img-blog.csdnimg.cn/a0472fa2636c428ea34dfc06b12755eb.jpeg)
...
1. 如图3-33所示，有五个站点分别连接在3个局域网上，并且用网桥B1和B2连接起来，每一个网桥都有两个接口（1和2),初始时，两个网桥中的转发表都是空的，以后有以下各站向其他的站发送了数据帧:A发送给E,C发送给B,D发送给C，B发送给A,请把有关信息填写在表3-4中。
   ...
   ![image-20230206174029998](https://img-blog.csdnimg.cn/dcb7d36a91474889a836e080f23e79a7.jpeg)

   ![image-20220501205033503](https://img-blog.csdnimg.cn/a4f6faa5baa34c2089c1207eda1e3a49.jpeg)
...
2. 图1表示有7个站(H1\~h7，相应的MAC地址为MAC1\~MAC7)分别连接在四个局域网上，并且用网桥B1、B2、以及B3连接起来。每个网桥都有两个端口（1和2）。在一开始，三个网桥的转发表都是空的。以后有以下各站向其他站发送了数据帧：...（如表所示）。
   ...
   ![img](https://img-blog.csdnimg.cn/eccd19397c2d40ef97d604a74f10cf4c.jpeg)

   ![img](https://img-blog.csdnimg.cn/bba312dc9dbd436b95e03b7802b5c4f5.jpeg)
...
![image-20230205103346340](https://img-blog.csdnimg.cn/a70cd19cd1ea476a84533d7a9126c223.jpeg)
...
![image-20221228123643488](https://img-blog.csdnimg.cn/c40b7a34698b43f19ccfc3fb7bbccf7f.jpeg)
...
![image-20221228123241962](https://img-blog.csdnimg.cn/6bc54fe9dd0f4970ba5188f9fd7bf1a5.jpeg)
...
![image-20221218202531896](https://img-blog.csdnimg.cn/c0241da84cfd46e0a9c3c1ac3bb7dc42.jpeg)
...
3. 在发送过程中仍不停地检测信道，即网络适配器要**边发送边监听**（②边发边听）。这里只有两种可能性： 
   ...
   2. 发送失败：在争用期内检测到碰撞。这时立即停止发送数据，并按规定发送人为干扰信号（③冲突停止）。适配器接着就执行**指数退避算法**，等待r倍512比特时间后，返回到步骤(2)，继续检测信道。但若重传达16次仍不能成功，则停止重传而向上报错。
...
1. 
   ...
   ![image-20230203124448202](https://img-blog.csdnimg.cn/2207713c368945afbfd0e732d4cd5743.jpeg)
...
![image-20221228101327545](https://img-blog.csdnimg.cn/2e92745877114394bdde74ba6cd1ae33.jpeg)
...
实现网络互连，完成分组在计算机网络核心部分的传输，即实现分组在多个网络的传输。为**主机之间**提供逻辑通信。
...
![image-20221228155617728](https://img-blog.csdnimg.cn/d9d205c134bc4434ba663bd02e136708.jpeg)
...
![image-20221228155641623](https://img-blog.csdnimg.cn/db7aa74e36434a76b9acd4fcafd07bc4.jpeg)
...
![image-20221228165921449](https://img-blog.csdnimg.cn/d8cd2c8581cc418eafb0285db5271403.jpeg)
...
![image-20221228181137208](https://img-blog.csdnimg.cn/aeed7b13406944f6805211ea47ec2006.jpeg)
...
![image-20221228211223234](https://img-blog.csdnimg.cn/b6c6eda5a6674866ae74fe8e761aa110.jpeg)
...
* 数据字段格式
  ...
  ![image-20221228212034411](https://img-blog.csdnimg.cn/97a59376e0c04a41baf326bb3e2ad84d.jpeg)
...
3. 网络层使用的中间设备叫做**路由器(router)**。（可以隔离广播域）
   ...
   路由器是读取每一个数据包中的地址然后决定如何**转发分组**的专用智能网络设备，用于连接多个**逻辑上分开的**，使用**相同网络层协议**的**网络**。
...
![image-20230205105752099](https://img-blog.csdnimg.cn/1d2de069a766451698742d3075d49c68.jpeg)
...
![image-20230205112149698](https://img-blog.csdnimg.cn/247edf380a0b4fcdaa0199d8bf357f1e.jpeg)
...
![image-20221228170713097](https://img-blog.csdnimg.cn/142c4f7025d74bbcae4bffcc370bc4e1.jpeg)
...
![image-20221228173146497](https://img-blog.csdnimg.cn/e2e69d8fc0f140d58b515a6c697ee605.jpeg)

##### 分类

![image-20221228173130618](https://img-blog.csdnimg.cn/ddfac87e94b24555acda38aa6472fa10.jpeg)

D类为组播地址，只能作为目标IP地址使用，不能作为源IP使用

###### A类地址详细信息

![image-20221228174940435](https://img-blog.csdnimg.cn/fb008f172c114845aeccd51fd88d109d.jpeg)

###### B类地址详细信息

![image-20221228175100658](https://img-blog.csdnimg.cn/cc1c451868ee47efa2feb3cca75420d2.jpeg)

###### C类地址详细信息

![image-20221228175130946](https://img-blog.csdnimg.cn/0bf2abc43e91450abe96fa5e547847a2.jpeg)

##### IP地址的指派范围

![image-20221228173519557](https://img-blog.csdnimg.cn/ea05c3fcdc5742758ffb5eabfdc39704.jpeg)

##### 一般不使用的特殊IP地址

![image-20221228173716505](https://img-blog.csdnimg.cn/89500495539547cca7fadb0b42def33c.jpeg)
...
* 从主机号借用若干个位作为子网号 subnet-id，而主机号 host-id 也就相应减少了若干个位。
  ...
  ![image-20230205114541470](https://img-blog.csdnimg.cn/43884ebbfba0409dba0c083b52903648.jpeg)

  IP 地址 ::= { <网络号>, <子网号>, <主机号> }

* 划分子网纯属一个单位**内部**的事情。单位对外仍然表现为没有划分子网的网络。

* 凡是从其他网络发送给本单位某个主机的 IP 数据报，仍然是根据 IP 数据报的**目的网络号** net-id
...
![image-20230205115152344](https://img-blog.csdnimg.cn/2bae963dfb1d49a6a5a7aef47ccebb9a.jpeg)
...
![image-20230205115311272](https://img-blog.csdnimg.cn/18cddd60aacf44b1977e81e5a462cde2.jpeg)

##### 例题

1. B类地址的子网划分选择（使用固定长度子网)

   ![image-20230205115624875](https://img-blog.csdnimg.cn/e35694d7f2c142f0989532a7500599ff.jpeg)
...
2. 【例4-2】已知 IP 地址是 141.14.72.24，子网掩码是 255.255.192.0。试求网络地址。
   ...
   ![image-20221228204033603](https://img-blog.csdnimg.cn/18eba4b8cabb4716b6605e23b75bb7a0.jpeg)

3. 【例4-3】上例中，若子网掩码改为 255.255.224.0，试求网络地址，讨论所得结果。

   ![image-20221228204049570](https://img-blog.csdnimg.cn/5e3fc8a6dec44952b0ee364574489a41.jpeg)
...
1. 地址块10.0.0.0/10可简写为10/10，也就是把点分十进制中**低位连续的0省略**。
2. 在网络前缀的后面加一个星号\*，如：
   00001010 00\*
   意思是：在星号\*之前是网络前缀，而星号\*表示IP地址中的**主机号**，可以是任意值
...
这个地址块共有2^12^个地址。上面的地址块可记为128.14.32.0/20或10000000 00001110 0010*。在不需要指出地址块的起始地址时，也可把这样的地址块简称为“/20地址块” 。

###### 常用的CIDR地址块

![image-20230205144638831](https://img-blog.csdnimg.cn/5a0ae0a6b96a4fae8b0551d37100041e.jpeg)
...
![image-20221228210615561](https://img-blog.csdnimg.cn/1670495595394f75bb9abd4f7f913691.jpeg)
...
![image-20230210164011505](https://img-blog.csdnimg.cn/efe31271b8e143728db2dcd9c6e494b9.jpeg)

##### 例题

4-24※ 已知路由器R1的转发表如下表所示。试画出各网络和必要的路由器的连接拓扑，标注出必要的IP地址和接口，对不能确定的情况应当指明。

![image-20230206180227081](https://img-blog.csdnimg.cn/f265f376695d44d0b966d87bf9dbb508.jpeg)

![img](https://img-blog.csdnimg.cn/bed0a4d20a2a4e5fba93a60595ad6b3c.jpeg)

4-25 一个自治系统有5个局域网，其连接图如图所示。LAN2至LAN5上的主机数分别为：91、150、3和15。该自治系统分配到的IP地址块为30.138.118/23。试给出每一个局域网的地址块（包括前缀）（答案不唯一）。

![image-20221230200236330](https://img-blog.csdnimg.cn/2a8f1db197c8436c8adcdebeaeaaea11.jpeg)
...
![image-20221230201010298](https://img-blog.csdnimg.cn/bf5c7b7b2ed74bfbb8d92c509ce41ade.jpeg)
...
![image-20221230201426328](https://img-blog.csdnimg.cn/ac405266444648fa96a8d4b7a490f2e1.jpeg)
...
![image-20221230212006074](https://img-blog.csdnimg.cn/c5c60e836c4b45efa44917a7b08b93f1.jpeg)
...
![image-20221228182214639](https://img-blog.csdnimg.cn/f538f903fe714aa2aa3db0802a1df321.jpeg)
...
占 16 位，指首部和数据之和的长度，单位为字节，因此数据报的最大长度为 65535 字节。若**IP数据报**总长度超过数据链路层**数据部分**的最大传送单元 MTU（Maximum Transfer Unit）则需要分片。

##### 标识(identification) 

占16 位。IP 软件在存储器中维持一个计数器，每产生一个数据报，计数器就加 1，并将此值赋给标识字段。但这个“标识”并不是序号，因为IP是无连接服务，数据报不存在按序接收的问题。当数据报由于长度超过网络的MTU而必须分片时，这个标识字段的值就被**复制到所有的数据报片的标识字段中**。相同的标识字段的值使分片后的各数据报片最后能正确地**重装**成为原来的数据报。
...
* 分片示意图
  ...
  ![分片示意图](https://img-blog.csdnimg.cn/4ec7cd820adf48a59dbfec7390d7775a.jpeg)
...
占 8 位，记为 TTL (Time To Live)， 指示数据报在网络中**可通过的路由器数的最大值**。功能为“跳数限制”。路由器在每次转发数据报之前就把TTL值减1。若 TTL值减小到零，就丢弃这个数据报，不再转发。
...
占16位，只检验数据报的首部， 不检验数据部分。这里不采用 CRC 检验码而采用简单的16 位**二进制反码求和**算法。

###### 计算规则

![image-20221228184948853](https://img-blog.csdnimg.cn/b857bce5f17c481f99b5510e1eb40fef.jpeg)

**二进制反码求和**规则： 0和0相加是0，0和1相加是1，1和1相加是0但要产生一个进位1，加到下一列。若最高位相加后产生进位，则最后得到的结果要加上溢出的进位 1 (可能有多个1)。

![image-20221228184845877](https://img-blog.csdnimg.cn/eb4ed1de2de945e29626c887d487241d.jpeg)
...
* 根据目的网络地址利用[路由器分组转发算法](#路由器分组转发算法)就能确定下一跳路由器，这样做的结果是：
  * IP 数据报最终**一定**可以找到目的主机所在目的网络上的路由器（可能要通过多次的**间接交付**）。
  * 只有到达最后一个路由器时，才向目的主机进行**直接交付**。

![image-20221228190004065](https://img-blog.csdnimg.cn/44187971fb514e199243f8d45224d3b6.jpeg)
...
![image-20221230122540918](https://img-blog.csdnimg.cn/cab159f0d7e545799b58d921d9985bb8.jpeg)
...
![image-20221230160742769](https://img-blog.csdnimg.cn/3442a85d971f4562bce0f9a07a4789a9.jpeg)
...
在路由器中运行，**自动**找到路由器转发分组**最合适的路径**

### 自治系统

将整个互联网划分为许多较小的自治系统 （Autonomous System，AS），一个自治系统是一个互联网，其最重要的特点是自治系统有权自主地决定在**本系统内采用何种路由选择协议**。一个自治系统内的**所有网络都属于一个行政单位来管辖**。一个自治系统的**所有路由器**在本自治系统内**必须是连通的**。
...
路由信息协议 RIP (Routing Information Protocol) 是一种**分布式的**、基于**距离向量算法**的路由选择协议。 要求网络中的每一个路由器都要维护从它自己**到其他每一个目的网络的距离**记录。
...
![image-20221230105301301](https://img-blog.csdnimg.cn/8d1e35cdc68d4713a1d06aa984f208fb.jpeg)

* 路由器刚开始工作时，只知道自己到直连网络的距离为1.
* 每个路由器**仅和相邻路由器周期性地**交换并更新路由信息。
...
3. 若3分钟还没有收到相邻路由器的更新路由表，则把此相邻路由器记为**不可达的路由器**，即把距离置为16（距离为16表示不可达）。
...
![image-20221230111842260](https://img-blog.csdnimg.cn/67c3ff27b653487fb41e092d3ef38f54.jpeg)

1. 先把表4-9(b)中的距离都加1，并把下一跳路由器都改为R。得出表4-9(c)。

   ![image-20221230112128721](https://img-blog.csdnimg.cn/47fa8d48a34f426eaa73acf0556ac6b9.jpeg)
...
2. 把这个表的每一行和表4-9(a)进行比较。
   ...
   ![image-20221230112254590](https://img-blog.csdnimg.cn/853de876fb734628a4b7617040f04288.jpeg)
...
![image-20221230104610613](https://img-blog.csdnimg.cn/6de195fe0be04c00bb4f11fd71cf3fd2.jpeg)
...
* 交互什么信息？（what）
  * 发送的信息就是与**本路由器相邻的所有路由器的链路状态**，但这只是路由器所知道的部分信息。
* 什么时候交互信息？（when）
...
* 内部网关协议IGP寻找一条**最佳路由**
* 外部网关协议EGP（如BGP）寻找一条能够到达目的网络且**比较好**的路由（不兜圈子）
...
* 与谁交换信息？（who）
  * 仅和**相邻BGP发言人**交换信息。
* 交互什么信息？（what）
  * 交换的信息是当前本BGP发言人所知道的**全部路径信息**。（**路径向量**path vector） 
* 什么时候交互信息？（when）
  * 按**固定的时间间隔**交换信息（30秒）。

###### BGP发言人

![image-20221230115414038](https://img-blog.csdnimg.cn/81354af9380d4a7388504ccd3c5e861b.jpeg)

## IPv6

### 出现原因

1. 互联网经过几十年的飞速发展，IPv4地址已经全部**耗尽**。
2. 解决IP地址耗尽的**根本措施**就是采用具有**更大地址空间**的新版本的 IP，即IPv6。
...
7. 支持资源预分配
8. 首部改为**8字节对齐**。首部长度必须是8字节的整数倍
9. IPv6 只有在**包的源结点才能分片**，是`端到端的`，**传输路径中的路由器不能分片**，所以从一般意义上说，`IPv6不允许分片`（不允许类似IPv4的路由分片)。

### 格式

#### 数据报格式

![image-20221230120318088](https://img-blog.csdnimg.cn/0e01db54f63746b5b9cbe6d29fa2bcf1.jpeg)

#### 首部格式

![image-20221230120338294](https://img-blog.csdnimg.cn/1cbe7f2bae2a42b790b37a329838a5b7.jpeg)
...
这是 IPv6 增加的一种类型。任播的目的站是一组计算机，但数据报在交付时**只交付其中的一个**，通常是距离最近的一个。
...
双协议栈主机在和 IPv6主机通信时采用IPv6地址，而和 IPv4主机通信时则采用IPv4地址。双协议栈主机**使用域名系统DNS来查询知道**目的主机是采用哪一种地址。若DNS返回的是IPv4地址，双协议栈的源主机就使用IPv4地址。但当DNS返回的是IPv6地址，源主机就使用IPv6地址。
...
![image-20221230121003815](https://img-blog.csdnimg.cn/8795ec7cd1e34038a21ab96358c04159.jpeg)
...
![image-20221230121622200](https://img-blog.csdnimg.cn/2b37ac1187684fce8580328eb73bab7a.jpeg)

### ICMPv6

使用ICMP来反馈一些差错信息。它合并了IPv4中地址解析协议ARP和网际组管理协议IGMP的功能。是面向报文的协议。

![image-20230203170553123](https://img-blog.csdnimg.cn/653d1018a5e64d88b679749447adb182.jpeg)
...
![image-20221230173511541](https://img-blog.csdnimg.cn/f586f348558543329591b5f5a43a4fc8.jpeg)
...
![image-20221230174055558](https://img-blog.csdnimg.cn/a24e44ac1c8a4650b736ff248c920151.jpeg)
...
![image-20221230181807693](https://img-blog.csdnimg.cn/60bf438704ab4248900a38d143bd36b7.jpeg)

## 解决ip地址耗尽的措施

1. 采用[划分子网](#子网的划分)，使IP地址的分配更加合理，减少 IP 地址的浪费
2. 采用无类别编址[CIDR](#构成超网(CIDR))，使IP地址的分配更加有效，减少 IP 地址的浪费
3. 采用网络地址转换[NAT](#NAT)方法以节省全球IP地址
4. 采用具有更大地址空间的新版本的IP协议[IPv6](#IPv6)
...
![image-20221230213119568](https://img-blog.csdnimg.cn/92165f23a865497187c0b66d966d4c19.jpeg)
...
UDP 只在 IP 的数据报服务之上增加了很少一点的功能：**复用和分用**和**差错检测**
...
![image-20221231114357398](https://img-blog.csdnimg.cn/b9fc70246dc34abbb407c2a179e43f19.jpeg)
...
![image-20221231114643101](https://img-blog.csdnimg.cn/0a78a0384cb6466c8df30d082a7ec083.jpeg)
...
3. 提供**可靠**交付的服务。通过TCP连接传送的数据，无差错、不丢失、不重复，并且按序到达。

4. 提供**全双工**通信。TCP运行通信双方的应用进程在任何时候都能发送数据。
...
5. 面向字节流。
   ...
   ![image-20221231115811942](https://img-blog.csdnimg.cn/a8cd13e9b0004c9c967950e2ffca264b.jpeg)
...
* 同一个IP地址可以有多个不同的TCP连接，而**同一个端口号**也可以出现在**多个不同的TCP连接**中。
...
![image-20221231152331184](https://img-blog.csdnimg.cn/0f9570ef6462420c8c92a37ef54522e7.jpeg)
...
![image-20221231154606148](https://img-blog.csdnimg.cn/360baf06fc8f4689b5fd3f48b2ccd6a6.jpeg)
...
* 这两种情况下，B 都**不会发送任何确认信息**。
  ...
  2. M1 在传输过程中丢失了，这时 B 当然什么都不知道，也什么都不做。
     ...
     ![image-20221231152751806](https://img-blog.csdnimg.cn/f3b996eec212461893e367aaf5a6c46c.jpeg)
...
![image-20221231153543635](https://img-blog.csdnimg.cn/cfede3c7cd854c22bcff39ffd1000009.jpeg)
...
![image-20221231153614546](https://img-blog.csdnimg.cn/98a1a1abc00b44029fc2b21ea410024d.jpeg)
...
![image-20230206155014604](https://img-blog.csdnimg.cn/fe5a0ea54d1848258accc922d6bc8e73.jpeg)
...
![image-20230102171844389](https://img-blog.csdnimg.cn/4f056db7454e444eae9f7d16b346cad6.jpeg)
...
1. 根据接收方 B 给出的窗口值，发送方 A 构造出自己的发送窗口。
   ...
   ![image-20230101174856815](https://img-blog.csdnimg.cn/1d1ff6c1050747da998727d20f71c1cd.jpeg)
...
2. A发送数据
   ...
   ![image-20230101175636927](https://img-blog.csdnimg.cn/ef9855f55dfc47099e502fdb0cf46fcc.jpeg)
...
3. B接收数据并发送确认报文
   ...
   2. 部分已发送数据按序到达
      ...
      ![image-20230101181050338](https://img-blog.csdnimg.cn/13d284f76bec4355b3045222ba0c5a06.jpeg)
...
4. A 的发送窗口内的序号都已用完， 但还没有再收到确认，必须停止发送。
   ...
   ![image-20230101181826521](https://img-blog.csdnimg.cn/eda333c003244798ae0c21751ca4caf1.jpeg)
...
![image-20230101213347946](https://img-blog.csdnimg.cn/976a5238d524470785f25e0809716d63.jpeg)
...
![image-20230102094949664](https://img-blog.csdnimg.cn/ef14d76ee47644758f28fb6134b532d3.jpeg)
...
![image-20230102100424227](https://img-blog.csdnimg.cn/4f2bc9d620104ea09c77704e85f40f09.jpeg)
...
* 举例
  ...
  ![image-20230102102737251](https://img-blog.csdnimg.cn/627ce6a55b314fa282c7febe2070e81e.jpeg)

###### 快恢复 (fast recovery)

* 定义

  * 当发送端收到**连续三个重复的确认**时，由于发送方现在认为网络很可能没有发生拥塞，因此现在不执行慢开始算法，而是执行快恢复算法 FR (Fast Recovery) 算法。
...
* 举例
  ...
  ![image-20230102100424227](https://img-blog.csdnimg.cn/89a6345632754d2d989f228348ac47d4.jpeg)
...
![image-20230102103651710](https://img-blog.csdnimg.cn/e0140dc71c2643a6a1a6fdcd588c066d.jpeg)
...
![image-20230102172313557](https://img-blog.csdnimg.cn/cb3d4d5a750c4a7a8d83622758707e0c.jpeg)
...
![image-20221231161044107](https://img-blog.csdnimg.cn/13a73f5294f84f5bb837d5e288a7ec3d.jpeg)
...
<div data-v-37f6d0fe=""><p><span>TCP共使用以下四种计时器，即重传计时器、持续计时器、保活计时器和时间等待计时器。这几个计时器的主要特点如下：</span><br><span>  重传计时器：当TCP发送报文段时，就创建该特定报文段的重传计时器。可能发生两种情况：若在计时器截止时间到之前收到了对此特定报文段的确认，则撤销此计时器。若在收到了对此特定报文段的确认之前计时器截止期到，则重传此报文段，并将计时器复位。</span><br><span>  持续计时器：为了对付零窗口大小通知，TCP需要另一个计时器。假定接收TCP宣布了窗口大小为零。发送TCP就停止传送报文段，直到接收TCP发送确认并宣布一个非零的窗口大小。但这个确认可能会丢失。我们知道在TCP中，对确认是不需要发送确认的。若确认丢失了，接收TCP并不知道，而是会认为它已经完成任务了，并等待着发送TCP接着会发送更多的报文段。但发送TCP由于没有收到确认，就等待对方发送确认来通知窗口的大小，双方的TCP都在永远地等待着对方。</span><br><span>  要打开这种死锁，TCP为每一个连接使用一个持续计时器。当发送TcP收到一个窗口大小为零的确认时，就启动持续计时器。当持续计时器期限到时，发送TCP就发送一个特殊的报文段，叫做探测报文段。这个报文段只有一个字节的数据。它有一个序号，但它的序号永远不需要确认；甚至在计算对其他部分的数据的确认时该序号也被忽略。探测报文段提醒接收TCP：确认已丢失，必须重传。</span><br><span>  持续计时器的值设置为重传时间的数值。但是，若没有收到从接收端来的响应，则需发送另一个探测报文段，并将持续计时器的值加倍和复位。发送端继续发送探测报文段，将持续计时器设定的值加倍和复位，直到这个值增大到门限值(通常是60秒)为止。在这以后，发送端每隔60秒就发送一个探测报文段，直到窗口重新打开。</span><br><span>  保活计时器：保活计时器使用在某些实现中，用来防止在两个TCP之间的连接出现长时期的空闲。假定客户打开了到服务器的连接，传送了一些数据，然后就保持静默了。也许这个客户出故障了。在这种情况下，这个连接将永远地处理打开状态。</span><br><span>  要解决这种问题，在大多数的实现中都是使服务器设置保活计时器。每当服务器收到客户的信息，就将计时器复位。超时通常设置为2小时。若服务器过了2小时还没有收到客户的信息，它就发送探测报文段。若发送了10个探测报文段(每一个相隔75秒)还没有响应，就假定客户出了故障，因而就终止该连接。</span><br><span>  时间等待计时器：时间等待计时器是在连接终止期间使用的。当TCP关闭一个连接时，它并不认为这个连接马上就真正地关闭了，在时间等待期间中，连接还处于一种中间过渡状态。这就可以使重复的FIN报文段(如果有的话)可以到达目的站因而可将其丢弃，这个计时器的值通常设置为一个报文段的寿命期待值的两倍。</span></p></div>
...
![image-20230102162840006](https://img-blog.csdnimg.cn/c7e52a7def3a4f67be1408c46400c01c.jpeg)
...
![image-20230102163525390](https://img-blog.csdnimg.cn/c3dd1eccf38b42b8b7251f06381e9345.jpeg)
...
![image-20230102165726619](https://img-blog.csdnimg.cn/82e00d3cad684f71a33c338f8d80ff34.jpeg)
...
![img](https://img-blog.csdnimg.cn/51f95464a11548cfaded17fc63bd1cb3.jpeg)
...
![image-20230102184104080](https://img-blog.csdnimg.cn/28123e720d8b4a678a7c615fe7d432aa.jpeg)
...
![image-20230102185309866](https://img-blog.csdnimg.cn/d6e1013f404044258960c3a9b35ae901.jpeg)
...
![image-20230102185500930](https://img-blog.csdnimg.cn/3a444920cecb469bac7fc862e4c0a414.jpeg)
...
![image-20230103101419348](https://img-blog.csdnimg.cn/14523e114be549e599b639c42fcdaa54.jpeg)

如果主机所询问的本地域名服务器不知道被查询域名 的 IP 地址，那么本地域名服务器就以 DNS 客户的身份，向其他根域名服务器继续发出查询请求报文。

##### 迭代查询

![image-20230103101436923](https://img-blog.csdnimg.cn/2523a31ce547478d8e8707c899a0c754.jpeg)
...
文件传送协议 FTP (File Transfer Protocol) 是互联网上使用得最广泛的文件传送协议。基于**TCP**
...
![image-20230103103203923](https://img-blog.csdnimg.cn/ef9b9ff8f8b341b596838adeb448ef7b.jpeg)
...
![image-20230103114746841](https://img-blog.csdnimg.cn/df3d1fa27cb8428cb14c1efba03cea0c.jpeg)
...
![image-20230103120152121](https://img-blog.csdnimg.cn/e73e8c4460b843209e715d17cd92649f.jpeg)
...
![image-20230103162609710](https://img-blog.csdnimg.cn/54184b5005cc497da7cab6f050b9488d.jpeg)
...
![image-20230103172508141](https://img-blog.csdnimg.cn/915bd11837a14852bf6a07695d84cb98.jpeg)
...
![image-20230103174336924](https://img-blog.csdnimg.cn/e86543b4dfd14781b3b87b58a263d84c.jpeg)
...
![image-20230103184629744](https://img-blog.csdnimg.cn/8df55991dce240b88b9031915c44955f.jpeg)
...
![image-20230103191045006](https://img-blog.csdnimg.cn/eaeeaf1574944f4e8083a6691784bc6b.jpeg)
...
![image-20230103185936462](https://img-blog.csdnimg.cn/ad270d31c32e443d99ef61b8b6c949ab.jpeg)
...
### [网络强国战略重要性](https://m.gmw.cn/baijia/2021-02/03/34595415.html)
